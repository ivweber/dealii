                          ...
                          const char *        name)
{
    ...
    const unsigned int max_test_deriv = std::min(((dim == 1) ? 3 : 1), static_cast<int>(degree - 1) / 2);
    ...
    FEValues<dim> fe(mapping,
                     finel,
                     q,
                     UpdateFlags(update_values | update_gradients | update_hessians | update_3rd_derivatives ));
                            ...
                            for (unsigned int i = 0; i < sz; ++i)
                            {
                                ...
                                switch(deriv_level)
                                {
                                    ...
                                    case 2:
                                        ...
                                        deallog << " " << fe.shape_hessian(i,k)[entry_1][entry_2] + 1.;
                                        break;
                                    case 3:
                                        if (dz == 1)
                                        ...
                                        deallog << " " << fe.shape_3rd_derivative(i,k)[entry_1][entry_2][entry_3] + 1.;
                                        break;
                                    default:
